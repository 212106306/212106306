<template>
    <div>
        ...
        >
            <el-table-column prop="id" label="快递单号" width="60"> </el-table-column>
            ...
            <el-table-column prop="count" label="重量（kg）" width="150">
            </el-table-column>
        ...
        >
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                ...
                <el-form-item label="网点" prop="storage">
                    <el-col :span="20">
                        <el-select
                ...
                <el-form-item label="重量（kg）" prop="count">
                    <el-col :span="20">
